...
JAVA_OPTS="-server -Xms512m -Xmx512m -Xmn200m -XX:MetaspaceSize=256m -XX:MaxMetaspaceSize=256m -Xverify:none -XX:+DisableExplicitGC -Djava.awt.headless=true -Duser.home=/tmp $CONF_OPTS $NACOS_OPTS"
#SpringBoot=$2
SpringBoot=
